...
import (
	...
	"github.com/Renloi/Renloi/command/server/export"
...
func GetCommand() *cobra.Command {
	serverCmd := &cobra.Command{
		Use:     "server",
		Short:   "The default command that starts the Renloi client, by bootstrapping all modules together",
		PreRunE: runPreRun,
		Run:     runCommand,
	}
...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		...
		"the data directory used for storing Renloi client data",
	)
